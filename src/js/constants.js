...
export const multimedia = [
  {
    group: "painting",
    images: [
      `${URLS_MULTIMEDIA.painting}1.jpg`,
      `${URLS_MULTIMEDIA.painting}2.jpg`,
      `${URLS_MULTIMEDIA.painting}3.jpg`,
      `${URLS_MULTIMEDIA.painting}4.jpg`,
      `${URLS_MULTIMEDIA.painting}5.jpg`,
    ],
  },
  {
    group: "soldering",
